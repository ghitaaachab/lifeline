class PatientSheetController < ApplicationController
  ...
  def patient_sheet_params
    params.require(:patient_sheet).permit(:blood_type, :height, :weight, :family_history, :surgical_history, :current_dr, :current_tt, :emergency_contact_name, :emergency_contact_number, :diseases_attributes, :allergies_attributes)
  end
end
